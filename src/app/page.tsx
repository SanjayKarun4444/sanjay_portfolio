    ...
    <section style={{ paddingBottom: "var(--sp-12)" }}>
      ...
      <section>
        ...
        <div style={{
          ...
          <ProjectCard title="Common" description={["Innovative proximity-based social networking application to connect like-minded people."]} stack="Flutter · Dart · Firebase"/>
