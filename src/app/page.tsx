              ...
              <section className="text-center grid grid-cols-1 items-center gap-8">
                <div className="space-y-3">
                  ...
                  <p className="text-center">
                    I&apos;m a 3rd year at UVA pursuing a B.S in Computer Science and Mathematics by 2026, along with a M.S in Computer Science expected to be completed by 2027. 
